...
class IMDbCrawler:
    ...
    def extract_top_250(self):
        ...
        if response.status_code == 200:
            ...
            movies_objects = soup.find_all('ul',
    ...
    def start_crawling(self):
        ...
        with ThreadPoolExecutor(max_workers=20) as executor:
            while (len(self.crawled) < self.crawling_threshold) and (
                    len(self.not_crawled) > 0) and crawled_counter < self.crawling_threshold:
    ...
    def get_director(self, soup):
        ...
        try:
            ...
            directors = [str(a.text) for a in directors_soup.find_all('a',
    ...
    def get_stars(self, soup):
        ...
        try:
            ...
            stars = [str(a.text) for a in stars_soup.find_all('a',
                                                              class_='ipc-metadata-list-item__list-content-item ipc-metadata-list-item__list-content-item--link')]
            return stars
        except:
    ...
    def get_writers(self, soup):
        ...
        try:
            ...
            writers = [str(a.text) for a in writers_soup.find_all('a',
                                                                  class_='ipc-metadata-list-item__list-content-item ipc-metadata-list-item__list-content-item--link')]
            return writers
        except:
    ...
    def get_related_links(self, soup):
        ...
        try:
            # TODO
            related_links = []
            related_objects = soup.find_all('a',
    ...
    def get_summary(self, soup):
        ...
        try:
            # TODO
            summaries_object = soup.find('div',
                                         {'data-testid': 'sub-section-summaries', 'class': 'sc-f65f65be-0 bBlII'})
    ...
    def get_synopsis(self, soup):
        ...
        try:
            # TODO
            synopsis = []
            synopsis_object = soup.find_all('div',
                                            class_='ipc-html-content ipc-html-content--base sc-8c0e9a24-0 iouSJu')
    ...
    def get_languages(self, soup):
        ...
        try:
            # TODO
            languages_list = []
            languages_object = soup.find('li', {'role': 'presentation', 'class': 'ipc-metadata-list__item',
                                                'data-testid': 'title-details-languages'})
            languages_soup = BeautifulSoup(str(languages_object), 'html.parser')
            languages = languages_soup.find_all('a',
    ...
    def get_countries_of_origin(self, soup):
        ...
        try:
            # TODO
            countries_list = []
            countries_object = soup.find('li', {'role': 'presentation', 'class': 'ipc-metadata-list__item',
                                                'data-testid': 'title-details-origin'})
            countries_soup = BeautifulSoup(str(countries_object), 'html.parser')
            countries = countries_soup.find_all('a',
                                                'ipc-metadata-list-item__list-content-item ipc-metadata-list-item__list-content-item--link')
    ...
    def get_budget(self, soup):
        ...
        try:
            # TODO
            budget_object = soup.find('li',
                                      {'role': 'presentation', 'class': 'ipc-metadata-list__item sc-1bec5ca1-2 bGsDqT',
